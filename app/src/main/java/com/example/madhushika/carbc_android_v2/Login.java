...
public class Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newUser_btn = (Button) findViewById(R.id.new_user_register);
        fogot_pw_btn = (Button) findViewById(R.id.forget_password);
            ...
            public void onClick(View v) {
                ...
                if (!login_statusStored){
                    ...
                    if (usernameGiven.equals(userNameStored) && passwordGiven.equals(passwordStored)){
                        ...
                        Toast.makeText(Login.this,"Please enter correct username and " +
