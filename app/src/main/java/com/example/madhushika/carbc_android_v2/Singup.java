        ...
        emailGiven.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if(s.length()>0){
                    if (!isValidEmail(s)){
                        //red
                        Toast.makeText(Singup.this,"not a valid email",Toast.LENGTH_SHORT).show();
                    }
                    else {
                        //green
                        Toast.makeText(Singup.this,"valid email",Toast.LENGTH_SHORT).show();
                    }
                }
            }
        ...
        confirmPasswordGiven.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if(s.equals(password)){
                    Toast.makeText(Singup.this,"confirmed",Toast.LENGTH_SHORT).show();
        ...
        register_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isValidEmail(email) && checkStrongPassword(password) && password.equals(confirmPassword)
                    ...
                    Toast.makeText(Singup.this,"Enter correct details",Toast.LENGTH_SHORT).show();
                }
            }
        });
